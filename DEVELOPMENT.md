...
```bash
git remote add encore encore://ai-trip-planner-c662
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ai-trip-planner-c662/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ai-trip-planner-c662/settings/integrations/github)
